...
public abstract class BlockMeiBase extends Block
{
    public String name;
    ...
    protected BlockMeiBase(String name, Material material, int iconDimensions, Class<? extends ItemBlockMeiBase> itemBlock, String... subNames)
    {
        super(material);
        this.name = name;
    ...
    public BlockMeiBase setMetaLightOpacity(int meta, int opacity)
    {
